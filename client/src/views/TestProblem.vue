...
export default {
  ...
  methods: {
    ...
    async checkInputFormat(callback) {
      ...
      await axios.post('//sntc.iitmandi.ac.in:3000/submissions/?base64_encoded=false&wait=true', check_format_body)
        .then((res) => {
    ...
    async getHackStatus() {
      ...
      await axios.post('//sntc.iitmandi.ac.in:3000/submissions/?base64_encoded=false&wait=true', correct_solution)
        .then((res) => {
      ...
      await axios.post('//sntc.iitmandi.ac.in:3000/submissions/?base64_encoded=false&wait=true', incorrect_solution)
        .then((res) => {
